const serviceArea = [
  {img: './assets/area/1.png', title: 'Research and Analytics'},
  {img: './assets/area/2.png', title: 'Risk Intelligince'},
  {img: './assets/area/3.png', title: 'Business and operations supports'},
  {img: './assets/area/4.png', title: 'Global marketing'},
  {img: './assets/area/5.png', title: 'Technical supports and solutions'},
  {img: './assets/area/6.png', title: 'Supply chain solution'},
]
